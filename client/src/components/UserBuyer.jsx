...
const UserBuyer = () => {
  ...
  return (
    <div className="buyer-profile">
      ...
      <img
        src={buyer.ProfilePicture || '/images/default-profile.jpg'}
        alt="Buyer"
      ...
      <div className="button-container">
        <button className="action-button" onClick={() => navigate(`/cart/${buyer.BuyerID}`)}>View Cart</button>
        <button className="action-button" onClick={() => navigate(`/your-auctions/${buyer.BuyerID}`)}>Your Auctions</button>
      </div>
    </div>
  );
};
